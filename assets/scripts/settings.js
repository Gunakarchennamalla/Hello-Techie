...
function initSdk(name) {
    ...
    setTimeout(function() {
        ...
        var chatWidgetSettings = {
            URI: 'oda-8021b2413cd649b597d1852d452e79e1-da12.data.digitalassistant.oci.oraclecloud.com',                               // ODA URI, only the hostname part should be passed, without the https://
	    ...
	    enableAutocomplete: true,                   // Enables autocomplete suggestions on user input
            ...
            i18n: {                                     // Provide translations for the strings used in the widget
                en: {                                   // en locale, can be configured for any locale
                    chatTitle: 'Supplier Assistant'    // Set title at chat header
                }
            },
			...
			logoIcon: 'https://i.pinimg.com/736x/8b/d8/97/8bd897f7fce9469a670f494768f21dec.jpg',
			botButtonIcon: 'https://i.pinimg.com/736x/8b/d8/97/8bd897f7fce9469a670f494768f21dec.jpg',
			personIcon: 'https://image.flaticon.com/icons/svg/3011/3011311.svg',
			
			clearMessageIcon: 'https://img.icons8.com/cute-clipart/64/000000/clear-symbol.png',
			closeIcon : 'https://img.icons8.com/cotton/64/000000/delete-sign--v2.png',
		};
    ...
    return new Promise(function(resolve) {
        setTimeout(function() {
            ...
            var payload = {
                iat: now,
                exp: now + 3600,
                channelId: '9b7d97b5-a6c8-4c86-9594-b09437535c84',
                userId: 'AnjuGunakar'
            };
            var SECRET = 'sDfPYd9Id1P4fDDPKwBZrZru6FgsntlO';
